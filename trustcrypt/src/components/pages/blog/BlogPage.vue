...
import {productsStore} from "../../../stores/store.js";
...
onMounted(async () => {
  await store.fetchBlogsLimit()
})


const selectedBlog = computed<BlogsItem>(() => {
  return store.blogs.find((blog) => blog.id === Number(route.params.id))
})

const linkToNextBlogId = (id) => {
      ...
      <div class="blog-item">
        ...
        <div class="blog-item__review">
          ...
          <div>
            ...
            Дата публикации: {{ selectedBlog.date }}
          </div>
          <a href="">
        ...
        <img class="blog-item__img" :src="selectedBlog.img" alt="img"/>
        <p>
      ...
      <div class="blog-aside">
        ...
        <div class="blog-aside__item" v-for="blog in store.blogs" :key="blog.id">
          ...
          <div class="blog-aside__item-text">
            ...
            <button type="button" @click="linkToNextBlogId(blog.id)">
              Просмотреть
            </button>
          </div>
        </div>
